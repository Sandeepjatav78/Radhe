  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 font-sans">
      ...
      <div className="text-center mb-16">
        <h2 className="text-3xl font-bold text-gray-900">Get in <span className="text-brand-dark">Touch</span></h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        ...
        {/* ✅ CLICKABLE: CALL US */}
        <a href="tel:+919817500669" className="bg-brand-light/50 p-8 rounded-2xl text-center border border-brand-light hover:shadow-md hover:bg-brand-light transition group cursor-pointer block">
        ...
        {/* ✅ CLICKABLE: EMAIL US */}
        <a href="mailto:radhepharmacy099@gmail.com" className="bg-brand-light p-8 rounded-2xl text-center border border-brand/10 hover:shadow-md hover:bg-brand-soft transition group cursor-pointer block">
          <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm text-2xl group-hover:scale-110 transition-transform">📧</div>
        ...
        <a href="https://maps.app.goo.gl/gDk7z8M4edSj9irh6" target="_blank" rel="noopener noreferrer" className="bg-brand-light p-8 rounded-2xl text-center border border-brand/10 hover:shadow-md hover:bg-brand-soft transition group cursor-pointer block">
          <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm text-2xl group-hover:scale-110 transition-transform">📍</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
          <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm flex flex-col justify-center">
              <h3 className="text-lg font-bold text-brand-dark mb-3 flex items-center gap-2">🕒 Operating Hours</h3>
              <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex justify-between items-center bg-brand-light px-3 py-2 rounded-lg border border-brand-light">
                      <span className="font-semibold text-gray-700">All Days (Mon - Sun)</span>
                      <span className="font-bold text-brand-dark text-base">6:30 AM - 10:30 PM</span>
                  </li>
              </ul>
          </div>

          <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm">
              <h3 className="text-lg font-bold text-brand-dark mb-3 flex items-center gap-2">📜 Regulatory Information</h3>
        ...
        <div className="w-full md:w-1/2 bg-white p-2">
            ...
            <form onSubmit={onSubmitHandler} className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <input required name="name" type="text" placeholder="Your Name" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-brand focus:border-brand transition-colors" />
                    <input required name="phone" type="number" placeholder="Phone Number" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-brand focus:border-brand transition-colors" />
                </div>
                
                <input required name="email" type="email" placeholder="Email Address" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-brand focus:border-brand transition-colors" />
                
                <textarea required name="message" rows="4" placeholder="Your Message or Medicine Query..." className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-brand focus:border-brand transition-colors"></textarea>
                ...
                <button 
                    ...
                    className="bg-brand text-white px-8 py-3.5 rounded-lg font-medium hover:bg-brand-dark transition-all duration-300 w-full sm:w-auto shadow-md hover:shadow-lg disabled:bg-gray-400 flex justify-center items-center gap-2"
                >
                    {isSubmitting ? (
                        <>Processing...</>
                    ) : (
